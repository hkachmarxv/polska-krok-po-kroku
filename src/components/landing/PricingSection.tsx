      ...
      <div className="container max-w-5xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-gradient-to-b from-primary/[0.04] to-card border-2 border-primary/40 rounded-2xl p-6 flex flex-col relative overflow-hidden shadow-xl shadow-primary/10 z-10"
          >
          ...
          >
            ...
            <p className="text-xs text-success font-medium mb-4">Save $280 vs 12 months</p>
            <ul className="space-y-2 mb-6 flex-1">
              {features.map((f, i) => (
                <li key={i} className="flex items-center gap-2 text-sm text-foreground">
                  <Check className="w-4 h-4 text-success flex-shrink-0" />
